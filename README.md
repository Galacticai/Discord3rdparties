...
| :---: | :---: | :---: | :---: |
| [Sunset](https://github.com/sunset-mod/Sunset) | A mod for @discord's mobile apps. Forked from Vendetta's recent sunset. | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🔴 Discontinued |
